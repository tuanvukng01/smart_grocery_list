...
# Function to perform classification on the input image
...
def detect_and_remove_item(interpreter, class_labels, root):
    image_path = "rice.png"  # Use a test image path
    result = classify_image(interpreter, image_path)
...
def create_ui():
    ...
    interpreter = load_model(model_path)  # Load the model
