...
def build_model(num_classes):
    ...
    model.classifier[1] = nn.Linear(model.last_channel, num_classes)  # Replace the classifier with our own
    return model

# Training function
def train_model(train_loader, val_loader, num_classes, model_save_path):
...
if __name__ == '__main__':
    ...
    train_model(train_loader, val_loader, num_classes, model_save_path)